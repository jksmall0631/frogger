...
function frogAndCarCollision(item, frog, self, lives){
...
Collision.prototype.frogCollision = function(frog, lives){
  var self = this;
  frogs.forEach(function(item, i){
  frogAndCarCollision(item, frog, self, lives);
  });
};

Collision.prototype.leftCarCollision = function(frog, lives){
  var self = this;
...
Collision.prototype.rightCarCollision = function(frog, lives) {
  var self = this;
